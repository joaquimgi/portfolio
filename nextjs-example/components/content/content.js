...
const Content = withNavigationContext(
  ({ fullpage, main, action, source, select, live }) => {
    return (
        ...
        <div className="content__action">
          ...
          {live != null && (
            <div className="content__action__github">
              <a target="_blank" href={`${live}`}>
                <span>See the live version</span>
              </a>
            </div>
          )}
          ...
          {source != null && (
            <div className="content__action__github">
              <a
                target="_blank"
                href={`https://github.com/joaquimgi/${source}`}
              >
          ...
          {!source && <div className="content__action__github"></div>}
        </div>
      </div>
    );
  }
